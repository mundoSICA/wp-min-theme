...
?>
		...
		<?php
			 ...
			 * Min enables a "Feature Widget Area" that should span both sidebar columns
		...
		<div id="primary" class="widget-area span4 well" role="complementary">
		<?php do_action( 'before_sidebar' ); ?>
			...
			if ( ! dynamic_sidebar( 'sidebar-1' ) ) : ?>
				...
				<li id="search" class="widget-container widget_search">
					<h3 class="widget-title"><?php _e( 'Search It!', 'min' ); ?></h3>
					<?php get_search_form(); ?>
				</li>

				<li class="widget-container">
					<h3 class="widget-title"><?php _e( 'Recent Entries', 'min' ); ?></h3>
						<ul>
							<?php
				...
				<li class="widget-container">
					<h3 class="widget-title"><?php _e( 'Links', 'min' ); ?></h3>
						<ul>
		...
		<?php
			/* If the current layout is a 3-column one, Min enables a second widget area called Secondary Widget Area
		...
		<div id="secondary" class="widget-area" role="complementary">
			<ul class="xoxo">
			<?php // A second sidebar for widgets. Min uses the secondary widget area for three column layouts.
			if ( ! dynamic_sidebar( 'secondary-widget-area' ) ) : ?>

				<li class="widget-container widget_links">
					<h3 class="widget-title"><?php _e( 'Meta', 'min' ); ?></h3>
					<ul>
						<?php wp_register(); ?>
